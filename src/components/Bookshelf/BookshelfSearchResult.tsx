...
import BookShelfResultCard from '././BookShelfSearchResultCard';
...
const BookShelfSearchResult: React.FC<BookShelfSearchResultProps> = ({
  ...
  return (
    <div className="flex flex-1 flex-col overflow-y-auto">
      {/* 검색 결과 개수 */}
      <div className="flex w-full items-center justify-between px-4 py-[5px] font-[Freesentation] text-[14px] font-medium text-[#58534E]">
